...
$result = 'SELECT * FROM coupon_generator_reports where `rep`=:rep';
$values = array(
			'rep' => $rep
			);
$rows = $w->fetchAll($result, $values);
?>
	...
	<div class="row">
		<div class="contain-to-grid">
			<nav class="top-bar" data-topbar role="navigation">
				<ul class="title-area">
					<li class="name">
					  <h1><a href="javascript:void(0);"> Gift Card Reports</a></h1>
					</li>
				</ul>
				<section class="top-bar-section">
					<ul class="right">
					  <li><a href="javascript:void(0);" id="generator">Generator</a></li>
					  <li class="active"><a href="javascript:void(0);" id="reports">Reports</a></li>
