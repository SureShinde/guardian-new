...
class Polcode_Shell_Exporter extends Mage_Shell_Abstract
{
    ...
    function getHHeader() {
        return "record_type,order_no,order_date,customer_name,address_1,address_2,city,state,zip,country,ship_via,freight, tax_code, tax_amount, tax_percent, phone, email_addr\r\n";
    }
    ...
    protected  function processOrders() {
        ...
        foreach($orders as $order) {
            ...
            $_orders .= sprintf("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\r\n",
                $recordType,
                $orderNo,
                $orderDate,
                $CustomerName,
        ...
        $filePath = $this->exportPath."/export-all-fixed/".$fileName;
